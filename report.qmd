...
The majority of the districts in Somalia are pastoral (34 districts), followed by agropastoral (19 districts). See @tbl-lsystem-districts and @fig-livelihood-systems. The table counts districts after excluding those with missing values, as described in @sec-data-wrangling.
