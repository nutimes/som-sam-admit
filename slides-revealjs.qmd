...
## {.smaller} 
#### What additional value or evidence does this analysis bring?
...
![](reports/data/map-incl-excl.png)
:::
::::
...
## {.smaller}
#### A glance at the evolution of admissions over time (month/year)
...
## {.smaller}
#### A glance at the evolution of admissions
:::: {.columns}
...
## {.smaller}  
#### The average rate of change (ARC) of the trend
...
## {.smaller}
#### Seasonal variation before and as of 2022
...
# Translating the graphs into a plain AMN seasonal calendar 🗓️
...
# Do these seasonal patterns align with the seasonality of food security 🧐 🤔 ?
...
## Seasonal variation (1/4) {.smaller}
...
## Seasonal variation (2/4) {.smaller}
...
## Seasonal variation (3/4) {.smaller}
