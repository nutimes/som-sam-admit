...
### Overview of the admissions over time at National level {#sec-overview-national}
...
### Overview of the admissions over time by livelihood systems  
#### Distribution of the number of district per livelihood system
...
#### A glimpse on the evolution of the admissions over time  
...
Decomposition of a time series consists in extracting each component that constitutes a time series data: the trend, the seasonal variation and any other variation in the data that cannot be explained by the aforementioned components [@tsR]. It helps to visualize clearly the underlying variation in the data that is due to the trend, and to seasonality, after removing on of them. 
