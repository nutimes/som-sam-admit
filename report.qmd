...
###  Implications on the IPC AMN analysis parameters

Current analysis parameters for **Gu**- and **Deyr**-based assessments

![](data/som-ipc-parameters.png)

Findings suggest a need for to rethink the AMN analysis parameters to match the times when *de facto* the evolution of AMN changes. This should be sensitive to the existing livelihood systems. Following seasonal calendars were developed based on this analysis findings: 
...
### Do these seasonal patterns agree with the seasonality of food security?  
The unveiled AMN seasonal patterns do not agree with or adhere to food security Jilaal, Gu and Hagaa's season, as it would, theoretically, be expected, but they do agree (to some extent) with the Deyr season.  
