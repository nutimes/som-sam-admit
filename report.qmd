...
All in all, the admissions in each livelihood system seem to follow the same pattern as that described in @sec-overview-national.
...
Given the notable fluctuations observed in the pattern during specific time periods, an average rate of change (ARC) [^1] [@arc] was calculated for each segment of the slopes described above. The results are summarized in @tbl-arc-national.
...
##### Seasonal pattern {#sec-sp-national}  
All in all, the seasonal component of the national-level data reveals a consistent seasonal pattern in the admissions, though it is **time-varying**. The **highest peak** of admissions occurs in **May and June**, preceded by a **lower trough consistently observed in April**, starting in February. A second peak is also seen in January, following an increase in admissions starting in November.
...
###### Seasonal pattern {#sec-sp-pastoral}   
