...
## Implications on the IPC AMN analysis parameters (1/5) {.smaller}

<br> 

+ Findings suggest a need for to rethink the AMN analysis parameters to match the times when *de facto* the evolution of AMN changes. 
    - This should be sensitive to the existing livelihood systems. 

<br> 

Following seasonal calendars were developed based on this analysis findings: 

## Implications on the IPC AMN analysis parameters (2/5) {.smaller}
...
%%| fig-cap: "Source: adaptation based on this analysis findings"
%%| fig-cap-location: bottom
%%| fig-height: 4
%%| fig-width: 13.7
gantt
...
## Implications on the IPC AMN analysis parameters (3/5) {.smaller}
...
## Implications on the IPC AMN analysis parameters (4/5) {.smaller}
...
gantt
    ...
    High AMN season :5, 7
    Low AMN season :7, 8
    High AMN season :8, 10
    Low AMN season :10, 12
```
:::
...
## Implications on the IPC AMN analysis parameters (5/5) {.smaller}
...
gantt
    ...
    section Seasons
    Jilaal :afi1, 1, 4
    High AMN season :amn1, 1, 2
    Gu     :afi2, 4, 7
    Low AMN season :amn2, 2, 5
    Post-Gu:afi3, 7, 8
    High AMN season :amn3, 5, 7
    Hagaa  :afi4, 7, 10
    Low AMN season :amn4, 7, 10
    Deyr   :afi5, 10, 12
    High AMN season : amn5, 10, 12
```
:::
...
gantt
    ...
    Low AMN season :amn2, 2, 5
    Post-Gu:afi3, 7, 8
    High AMN season :amn3, 5, 8
    Hagaa  :afi4, 7, 10
    Low AMN season :amn4, 8, 11
    Deyr   :afi5, 10, 12
    High AMN season : amn5, 11, 12
```
:::
...
gantt
    ...
    section Seasons
    Jilaal :afi1, 1, 4
    High AMN season :amn1, 1, 3
    Gu     :afi2, 4, 7
    Low AMN season :amn2, 3, 5
    Post-Gu:afi3, 7, 8
    High AMN season :amn3, 5, 7
    Hagaa  :afi4, 7, 10
    Low AMN season :amn4, 7, 8
    Deyr   :afi5, 10, 12
    High AMN season : amn5, 8, 10
    Low AMN season  : amn6, 10, 12
```
:::
...
gantt
    ...
    section Seasons
    Jilaal :afi1, 1, 4
    Low AMN season :amn1, 1, 5
    Gu     :afi2, 4, 7
    High AMN season :amn2, 5, 8
    Post-Gu:afi3, 7, 8
    Low AMN season :amn3, 8, 10
    Hagaa  :afi4, 7, 10
    High AMN season :amn4, 10, 12
    Deyr   :afi5, 10, 12
```
:::
